    ...
    * Implement method get_room_square that returns the square of our room
    ...
    def get_walls_square(self):
        ...
        for i in self.__walls:
            walls_square += i.wall_square()
        return walls_square

    def get_windows_square(self):
        windows_square = 0
        for i in self.__windows:
            windows_square += i.window_square()
    ...
    def get_number_of_rolls_of_wallpapers(self, roll_width_m, roll_length_m):
        sum_number_of_rolls_of_wallpaper = 0
        if roll_width_m == 0 or roll_length_m == 0:
            raise ValueError("Sorry length must be not 0")
        else:
            for i in self.__walls:
                sum_number_of_rolls_of_wallpaper += i.number_of_rolls_of_wallpaper(roll_width_m, roll_length_m)
            return sum_number_of_rolls_of_wallpaper
